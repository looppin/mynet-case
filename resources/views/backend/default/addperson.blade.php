                    ...
                    <div class="card-body">
                        ...
                        <form class="form-sample" action="{{route('person.store')}}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Adres 1</label>
                                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Adres 2</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="secondAddress"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
